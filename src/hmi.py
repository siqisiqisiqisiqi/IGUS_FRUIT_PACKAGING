...
class HMI:
    def __init__(self, img_sz=(800, 400), path="src/figures") -> None:
    ...
    def _init_layout(self):
        ...
        print(f"current work directory is {current_working_directory}.")
        block_3 = [[sg.Text('Package Type', font='Any 20')],
                   [sg.Radio("Type1", "bag", key='Type1', font='Any 12',
                    ...
                    sg.Image(f"{self.path}/type1.png", enable_events=True)],
                   [sg.Radio("Type2", "bag", key='Type2', font='Any 12',
                             enable_events=True, size=(10, 1)),
                    sg.Image(f"{self.path}/type2.png", enable_events=True)],
